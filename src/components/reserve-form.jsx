        ...
        <DialogHeader className="bg-gradient-to-bl from-blue-500  to-blue-500 -mx-6 -mt-6 px-6 py-4 rounded-t-lg">
          ...
          <DialogDescription className="text-white/90">
           International Conference on Applied Science, Engineering & Management
            <span className="text-white/80 text-sm mt-1">November 14th - 15th, 2025 • Kuala Lumper, Malaysia</span>
          </DialogDescription>
        </DialogHeader>
        <div className="relative">
          <div className="absolute -top-6 -right-6 w-24 h-24 bg-gradient-to-br from-pink-100 via-blue-100 to-yellow-100 rounded-full opacity-30"></div>
          <div className="absolute -bottom-10 -left-10 w-32 h-32 bg-gradient-to-br from-pink-100 via-blue-100 to-yellow-100 rounded-full opacity-20"></div>
          <form onSubmit={handleSubmit} className="space-y-4 mt-4 relative z-10">
            <div className="space-y-2">
              ...
              <Input
                ...
                className="border-gray-200 focus-visible:ring-blue-500 focus-visible:border-blue-500 bg-gray-50/50"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="phone-input-container">
                <PhoneInput
                  ...
                  className="flex h-10 w-full rounded-md border border-gray-200 bg-gray-50/50 px-3 py-2 text-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
                />
              </div>
            </div>
