  ...
  return (
    <div className="min-h-screen bg-[#f0f4f8] p-2 sm:p-4 md:px-6 overflow-hidden z-50  ">
      <div className="w-full max-w-screen-2xl mx-auto zoom-container">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-9 grid-rows-auto lg:grid-rows-10 gap-2 sm:gap-4 min-h-screen  z-0  ">
          ...
          <div className="col-span-2 row-span-3 lg:col-span-3 lg:row-span-3 lg:col-start-1 lg:row-start-8 order-2 lg:order-2">
            <div className="h-full bg-white rounded-2xl p-3 sm:p-6 xl:p-8 relative overflow-hidden shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
              ...
              <div className="mt-8 sm:mt-12 mb-4 sm:mb-8">
                <p className="text-gray-700 text-xs sm:text-sm xl:text-base leading-relaxed italic">
                  "Working with this team has been absolutely transformative for our organization. Their expertise and
          ...
          {/* Card 3 - CTA Card */}
          <div className="col-span-2 sm:col-span-4 row-span-2 lg:col-span-4 lg:row-span-2 lg:col-start-4 lg:row-start-8 order-3 lg:order-3">
            <Card className="h-full bg-white rounded-2xl p-3 sm:p-4 xl:p-6 flex flex-col sm:flex-row items-center justify-between overflow-hidden gap-3 sm:gap-0">
              ...
              <div className="flex-1 px-0 sm:px-4 xl:px-6 text-center sm:text-left">
                <div className="flex items-center justify-center sm:justify-start gap-2 mb-2 xl:mb-3">
                  ...
                  <span className="font-bold text-[#07416b] text-xs sm:text-sm xl:text-base">ICASEM 2025</span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3 xl:gap-4">
                  ...
                  <Link href="/about-conference">
                    <button className="flex border p-2 hover:border-[#00adef] rounded-2xl items-center gap-1 xl:gap-2 text-[#07416b] hover:text-[#00adef] text-xs sm:text-sm xl:text-base">
                      Learn More
                      <ArrowBigRightDashIcon className="w-3 xl:w-5 h-3 xl:h-5" />
                    </button>
                  </Link>
                </div>
              </div>
              {/* Right side - Conference dates */}
              <div className="text-center sm:text-right pl-2 items-center justify-center flex flex-col">
                <div className="text-lg sm:text-xl xl:text-3xl font-bold text-[#07416b]">Nov</div>
                <div className="text-sm sm:text-base xl:text-2xl font-semibold text-[#00adef]">
                  14<sup>th</sup>-15<sup>th</sup>
                </div>
                <div className="text-xs xl:text-lg text-gray-900 font-semibold">Singapore</div>
              </div>
            </Card>
          </div>

          {/* Card 4 - Stats Card */}
          <div className="col-span-2 row-span-2 lg:col-span-2 lg:row-span-3 lg:col-start-8 lg:row-start-8 order-4 lg:order-4">
