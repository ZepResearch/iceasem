export function getUserEmailTemplate(data) {
  ...
  <head>
    <meta charset="utf-8">
    <title>ICASEM Conference Submission Confirmation</title>
    <style>
      body {
    ...
    <div class="email-container">
      ...
      <div class="content">
        ...
        <div class="main-message">
          ...
          to the International Conference on Applied Science, Engineering & Management (ICASEM).
        </div>
        ...
        <div class="info-box">
          ...
          <ul class="info-list">
            ...
            <li>
              ...
              <span class="info-value">ICASEM-${new Date().getFullYear()}-${Math.random().toString(36).substr(2, 9).toUpperCase()}</span>
            </li>
          </ul>
        </div>
...
export function getAdminEmailTemplate(data, fileUrl) {
  ...
  <head>
    <meta charset="utf-8">
    <title>New ICASEM Conference Submission</title>
    <style>
      body {
        font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;
        line-height: 1.6;
    ...
    <div class="email-container">
      <div class="header">
        <div class="header-content">
          ...
          <h1 class="header-title">ICASEM Conference Submission</h1>
      ...
      <div class="content">
        <div class="notification-banner">
          ...
          <div class="notification-text">A new research paper has been submitted to ICASEM Conference</div>
        </div>
          ...
          <table class="details-table">
            ...
            <tr>
              ...
              <td class="field-value">
                <a href="mailto:${data.email}" style="color: #3b82f6; font-weight: 600;">${data.email}</a>
              </td>
            </tr>
            <tr>
