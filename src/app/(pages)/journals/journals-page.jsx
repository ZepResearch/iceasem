            ...
            >
              ...
              <span
                className={`
                  ...
                  ${isActive ? "bg-sky-500 text-white" : "bg-gray-100 text-gray-500"}
                `}
              >
                {tabCount}
              </span>
          ...
          return (
            <Link href={`/journals/${journal.id}`} key={journal.id} className="group">
              <Card className="overflow-hidden h-full transition-all duration-300 hover:shadow-lg border-gray-200 hover:border-gray-300">
                {/* Cover image */}
                <div className="relative h-[300px] bg-gradient-to-t from-sky-300 to-sky-800 w-full overflow-hidden">
                  {journal.imgs ? (
                    <Image
