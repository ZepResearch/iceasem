            ...
            return (
              ...
              >
                <div className="flex items-center gap-4 md:gap-6">
                  <div className="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-r from-[#00adef] to-[#07416b] text-primary-foreground font-bold text-lg flex-shrink-0">
                    {step.number}
                  </div>
