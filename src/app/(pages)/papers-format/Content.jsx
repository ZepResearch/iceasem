        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#07416b]/80 mb-8">
              Download templates and learn how to format your 3<sup>rd</sup>ICASEM 2027 submission
            </p>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="bg-[#f0f4f8] rounded-2xl p-4 border border-[#00adef]/20">
                ...
                <p className="text-sm text-[#07416b]/80 font-mono">
                  [1] A. Author, "Title of paper," in Proc. ICASEM, Vietnam, 2027, pp. 1-8.
                </p>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-r from-[#07416b] to-[#00adef] rounded-3xl p-8 lg:p-12 text-white text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <p className="text-lg lg:text-xl mb-8 opacity-90 max-w-2xl mx-auto">
                Download the appropriate template and prepare your submission for 3<sup>rd</sup>ICASEM 2027 following our IEEE
